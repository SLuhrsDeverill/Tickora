-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'IT_AGENT', 'EMPLOYEE');
...
-- CreateEnum
CREATE TYPE "TicketCategory" AS ENUM ('HARDWARE', 'SOFTWARE', 'NETWORK', 'EMAIL', 'PRINTER', 'ACCESS_PERMISSIONS', 'PHONE', 'OTHER');

-- CreateEnum
CREATE TYPE "AssetType" AS ENUM ('LAPTOP', 'DESKTOP', 'MONITOR', 'KEYBOARD', 'MOUSE', 'PRINTER', 'PHONE', 'TABLET', 'SERVER', 'SWITCH', 'ROUTER', 'UPS', 'HEADSET', 'WEBCAM', 'DOCKING_STATION', 'OTHER');

-- CreateEnum
CREATE TYPE "AssetStatus" AS ENUM ('ACTIVE', 'IN_REPAIR', 'RETIRED', 'AVAILABLE', 'RESERVED');
