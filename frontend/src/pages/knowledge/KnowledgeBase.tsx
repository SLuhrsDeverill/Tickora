...
import { Search, BookOpen, ThumbsUp, ThumbsDown, Eye, Plus, ChevronLeft } from 'lucide-react';
  ...
  if (selected) {
    ...
    return (
      <div className="max-w-3xl mx-auto">
        <button onClick={() => setSelected(null)} className="flex items-center gap-1 text-sm text-slate-500 hover:text-slate-700 mb-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          <div className="flex items-start justify-between mb-4">
            ...
            {isIT && (
              <button
                onClick={() => navigate(`/knowledge/edit/${selected.id}`)}
          ...
          <div className="mt-6 pt-4 border-t border-slate-100 flex items-center gap-4">
            ...
            <button
              onClick={() => handleHelpful(selected.id, true)}
            ...
            <button
              onClick={() => handleHelpful(selected.id, false)}
